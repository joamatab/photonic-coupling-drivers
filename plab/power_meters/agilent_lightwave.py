...
class AgilentLightWave:
    def __init__(
        ...
        self.laser = LaserAgilent8164B(
            gpib_num, gpib_dev_num, power_unit, laser_output_mode
        )
        self.power_meter = PowerMeterAgilent8164B(
            gpib_num, gpib_dev_num, power_meter_channel_num, power_unit
        )
