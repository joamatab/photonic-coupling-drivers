...
class LuminosStagesLR(st.Stages3):
    def __init__(
        self,
        com_port_number_input="luminos_lr_input",
        com_port_number_output="luminos_lr_output",
        com_port_number_chip="luminos_lr_chip",
        filename=None,
        C1_input=None,
        C2_input=None,
        C1_output=None,
...
class LuminosStageLR(ls.LuminosStage):
    def __init__(
        ...
        super().__init__(
            ...
            update_position_absolute=update_position_absolute,
            c1_c2_distance_mask_um=c1_c2_distance_mask_um,
            calibrate_c_axis=calibrate_c_axis,
            filename=filename,
