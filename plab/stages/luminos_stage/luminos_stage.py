...
class LuminosStages(st.Stages3):
    def __init__(
        self,
        com_port_number_input="luminos_input",
        com_port_number_output="luminos_output",
        com_port_number_chip="luminos_chip",
        filename=None,
        C1_input=None,
        C2_input=None,
        C1_output=None,
        ...
        input_x_axis_motor="x",
        input_y_axis_motor="y",
        input_z_axis_motor="z",
        output_x_axis_motor="x",
        output_y_axis_motor="y",
        output_z_axis_motor="z",
        chip_x_axis_motor="x",
        chip_y_axis_motor="y",
        chip_z_axis_motor="z",
        ctr_in_out_xy_axes=False,
        update_position_absolute=100,
        restore_default_settings=False,
        reverse_output_x_axis=True,
        home_input=False,
        home_chip=False,
        home_output=False,
    ):
        ...
        self.input = LuminosStage(
            com_port_number_input,
            C1=C1_input,
            C2=C2_input,
            C1_z_chip=C1_z_chip,
            C2_z_chip=C2_z_chip,
            ...
            filename=filename,
            x_axis_motor=input_x_axis_motor,
            y_axis_motor=input_y_axis_motor,
            z_axis_motor=input_z_axis_motor,
            restore_default_settings=restore_default_settings,
            home=home_input,
        )
        self.output = LuminosStage(
            com_port_number_output,
            C1=C1_output,
            C2=C2_output,
            C1_z_chip=C1_z_chip,
            C2_z_chip=C2_z_chip,
            ...
            update_position_absolute=update_position_absolute,
            filename=filename,
            x_axis_motor=output_x_axis_motor,
            y_axis_motor=output_y_axis_motor,
            z_axis_motor=output_z_axis_motor,
            reverse_axis_x=reverse_output_x_axis,
            restore_default_settings=restore_default_settings,
            home=home_output,
        )
        self.chip = LuminosStage(
            com_port_number_chip,
            filename=filename,
            update_position_absolute=update_position_absolute,
            x_axis_motor=chip_x_axis_motor,
            y_axis_motor=chip_y_axis_motor,
        ...
        super().__init__(
            ...
            filename=filename,
            ctr_in_out_xy_axes=ctr_in_out_xy_axes,
        )
...
class LuminosStage(st.Stage):
    def __init__(
        ...
        axes_idx, axes_dict = self._get_axes_dict(
            update_position_absolute=update_position_absolute,
    ...
    def _get_axes_dict(
        ...
        axes_dict = {
            ...
            "roll": LuminosAxisRoll(
                self._port, axes_idx["roll"], False, update_position_absolute, home
            ),
            "pitch": LuminosAxisPitch(
                self._port, axes_idx["pitch"], False, update_position_absolute, home
            ),
            "yaw": LuminosAxisYaw(
                self._port, axes_idx["yaw"], False, update_position_absolute, home
            ),
        }
        ...
        for axis_label, axis in self.axes.items():
            if axis_label in ("x", "y", "z"):
                ...
                if axis.axis_reversed == True:
                    axis._position_absolute = (
                        axis._position_absolute_max_nm - axis._position_absolute
                    )
...
class LuminosAxis(st.Axis, zs.BinaryDevice):
    def __init__(
        ...
        update_position_absolute=100,
        home=False,
        config_mask_set=0x08A0,
        config_mask_unset=0xC35F,
    ):
        ...
        super().__init__(
            reverse_axis, update_position_absolute=update_position_absolute
        )
...
class LuminosAxisLinear(LuminosAxis, st.AxisLinear):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            update_position_absolute=update_position_absolute,
            home=home,
            config_mask_set=config_mask_set,
            config_mask_unset=config_mask_unset,
        )
    ...
    def _get_current_position_nm(self):
        ...
        if (
            not self._position_absolute_min_nm
            <= pos_abs_nm
            <= self._position_absolute_max_nm
        ):
    ...
    def _set_maximum_position_nm(self, distance_from_home_nm):
        return self._set_maximum_position_steps(
            distance_from_home_nm / self.nm_per_step
        )

    def _set_maximum_position_um(self, distance_from_home_um):
        return self._set_maximum_position_nm(distance_from_home_um * 1000.0)
...
class LuminosAxisRotate(LuminosAxis, st.AxisRotate):
    ...
    def _get_current_position_arc_second(self):
        ...
        while (
            retry < 3
            and not self._position_absolute_min_arc_second
            <= pos_abs_arc_second
        ...
        if (
            not self._position_absolute_min_arc_second
            <= pos_abs_arc_second
            <= self._position_absolute_max_arc_second
        ):
            raise RuntimeError("Position not in range.")
    ...
    def _set_maximum_position_arc_second(self, angle_from_home_arc_second):
        return self._set_maximum_position_steps(
            angle_from_home_arc_second / self.arc_second_per_step
        )

    def _set_maximum_position_degree(self, angle_from_home_degree):
        return self._set_maximum_position_arc_second(angle_from_home_degree * 3600.0)
