...
class LaserAgilent8164B(AgilentLightWaveConnection, las.LaserTunable):
    ...
    def set_power_W(self, power_W):
        assert power_W < 5.0e-3, "Can't set power that high."
    ...
    def wavelength_sweep_interp(
        ...
        wavelengths, powers = self.wavelength_sweep(
            start_wavelength_nm,
            stop_wavelength_nm,
            step_wavelength_nm,
            max_power_W,
